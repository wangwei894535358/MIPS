...
HD_PWD='C:/Users/luzhe/Desktop/project_1/project_1.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log multiMips.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiMips.tcl -notrace
