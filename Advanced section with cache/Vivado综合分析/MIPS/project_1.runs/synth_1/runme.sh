...
HD_PWD='C:/Users/luzhe/Desktop/camera_zybo_01_01/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiMips.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiMips.tcl
